  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <h2>1. Who We Are</h2>
        <p>Revuly Inc. operates the Revuly platform at <a href="https://revuly.com">revuly.com</a>. We are the data controller for personal data collected through the Service. Contact us at <a href="mailto:privacy@revuly.com">privacy@revuly.com</a>.</p>
        ...
        <p>To exercise these rights, email <a href="mailto:privacy@revuly.com">privacy@revuly.com</a>. We will respond within 30 days.</p>
        ...
        <p>Questions? Contact our privacy team at <a href="mailto:privacy@revuly.com">privacy@revuly.com</a>. If you are in the EEA and believe we have not adequately addressed your concern, you have the right to lodge a complaint with your local data protection authority.</p>
      </div>
    </>
  );
}
