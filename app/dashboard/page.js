...
const T = {
  en: {
    ...
    trial_expired_sub: "Upgrade to keep getting reply suggestions.",
    ...
    no_reviews_sub: 'Click "Add Review" to manually add a customer review and get smart reply suggestions.',
    ...
    replied: "✓ Replied",
    delete_btn: "Delete",
    editor_empty_title: "Select a review to get reply suggestions",
    editor_empty_sub: "Click any review on the left to open the reply editor. Three different reply styles will be created for you.",
    lang_label: "Reply in:",
    over_limit: (n) => `You've used all ${n} smart replies this month.`,
    upgrade_plan: "Upgrade Plan →",
    btn_generate: "✦ Get Reply Suggestions",
    ...
    ys_learning_p: "Reply to a few more reviews using Copy. Once you have 3+ saved replies, Revuly will start generating in your personal voice.",
    modal_add_title: "Add Review",
    modal_add_sub: "Manually add a customer review to get smart reply suggestions.",
    ...
    comp_empty_sub: "Add up to 3 competitor restaurants to compare ratings, reviews, and the keywords guests mention. You can manage your list from Settings.",
    comp_go_settings: "Go to Settings to add competitors →",
    comp_manage_in_settings: "Manage competitors in Settings",
    ...
    // ── New: search-first / paste-link-secondary flow ──
    comp_search_primary_title: "Search competitor by name",
    comp_search_primary_help: "Find your competitor on Google by restaurant name + city. We'll show the top 5 matches.",
    comp_search_city_placeholder: "City",
    comp_search_top_matches: "Top matches",
    ...
    comp_paste_full_placeholder: "https://www.google.com/maps/place/...",
    comp_paste_full_only: "Only full Google Maps URLs are supported (must start with google.com/maps/place/...)",
    comp_get_full_url_help: "How to get the full Google Maps URL →",
  },
  zh: {
    live: "即時",
    ...
    comp_empty_sub: "最多可追蹤 3 家對手餐廳，比較評分、評論內容與關鍵字趨勢。可在「設定」頁面新增與管理。",
    comp_go_settings: "前往「設定」新增競爭對手 →",
    comp_manage_in_settings: "在「設定」管理競爭對手",
    kw_pos: "次正向提及",
    kw_neg: "次負向提及",
    // Paste-link flow
    ...
    // ── 新：以店名搜尋為主，貼連結為輔 ──
    comp_search_primary_title: "搜尋競爭對手店名",
    comp_search_primary_help: "輸入餐廳名稱與城市，從 Google 搜尋競爭對手。會顯示前 5 個最相符的商家。",
    comp_search_city_placeholder: "城市",
    comp_search_top_matches: "最相符的商家",
    comp_paste_link_toggle: "或貼上完整 Google Maps 連結",
    comp_paste_link_warning: "⚠ 不支援短連結（maps.app.goo.gl）。請從瀏覽器網址列複製完整網址。",
    comp_paste_full_placeholder: "https://www.google.com/maps/place/...",
    comp_paste_full_only: "只支援完整 Google Maps 網址（開頭必須是 google.com/maps/place/...）",
    comp_get_full_url_help: "如何取得完整 Google Maps 網址 →",
  },
};
...
export default function DashboardPage() {
  ...
  // Competitors tab — analysis-only on the dashboard. All add/remove
  // flow lives in Settings → Competitor Tracking now.
            ...
            <div className="competitors-pane">
              {!isPro ? (
                ...
                <>
                  ...
                  {/* Per-competitor blocks. Add/remove flow lives in Settings now. */}
                  {competitors.length === 0 && (
                    <div className="comp-empty">
                      <h4>{t.comp_empty_title}</h4>
                      <p>{t.comp_empty_sub}</p>
                      <a
                        href="/dashboard/settings#comp-section"
                        style={{
