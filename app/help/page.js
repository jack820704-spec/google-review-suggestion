      ...
      <div className="layout">
        ...
        <div className="content">
          ...
          <div className="section">
            ...
            <p><strong>I get an authorisation error.</strong> Try disconnecting and reconnecting. If the issue persists, contact revuly.support@gmail.com.</p>
          ...
          <div className="section">
            ...
            <div className="contact-card">
              ...
              <div className="contact-email"><a href="mailto:revuly.support@gmail.com">revuly.support@gmail.com</a></div>
